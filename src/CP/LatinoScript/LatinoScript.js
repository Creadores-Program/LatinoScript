    ...
    function latjs(code){
      ...
      function traductorLatjsAjs(code1, metod){
       if(metod == 1){
        ...
        code1 = code1.replaceAll("throw", "tirarError");
        code1 = code1.replaceAll("for", "para");
        code1 = code1.replaceAll("from", "desde");
        code1 = code1.replaceAll("default", "defecto");
        code1 = code1.replaceAll("import", "importarjs");
        code1 = code1.replaceAll("export", "exportarjs");
        code1 = code1.replaceAll("module-name", "nombre-modulo");
        code1 = code1.replaceAll("name", "nombre");
        code1 = code1.replaceAll("case", "caso");
        code1 = code1.replaceAll("{", "inicio");
        code1 = code1.replaceAll("}", "fin");
        code1 = code1.replaceAll("finelse ifinicio", "osi");
        code1 = code1.replaceAll("else if", "osi");
        code1 = code1.replaceAll("finelseinicio", "sino");
        code1 = code1.replaceAll("else", "sino");
        code1 = code1.replaceAll("switch", "elegir");
        code1 = code1.replaceAll("break", "romper");
        code1 = code1.replaceAll("doinicio", "hacer");
        code1 = code1.replaceAll("finwhile", "mientras");
        code1 = code1.replaceAll("do", "hacer");
        code1 = code1.replaceAll("while", "mientras");
        code1 = code1.replaceAll("function", "funcion");
        code1 = code1.replaceAll("let", "local");
        code1 = code1.replaceAll("const", "constante");
        code1 = code1.replaceAll("new", "nuevo");
        code1 = code1.replaceAll("as", "como");
        code1 = code1.replaceAll("continue", "continuar");
        code1 = code1.replaceAll("type", "tipo");
        code1 = code1.replaceAll("var", "global");
        ...
        code1 = code1.replaceAll("class", "clase");
        code1 = code1.replaceAll("implements", "implementos");
        code1 = code1.replaceAll("extends", "extiende");
        code1 = code1.replaceAll("static", "estatico");
        code1 = code1.replaceAll(/\baddEventListener\b/gi, "detectarEvento");
        code1 = code1.replaceAll("async", "asincrono");
        code1 = code1.replaceAll("in", "en");
        code1 = code1.replaceAll(/\blength\b/gi, "longitud");
        code1 = code1.replaceAll("of", "de");
        code1 = code1.replaceAll("if", "si");
        code1 = code1.replaceAll("return", "retornar");
        code1 = code1.replaceAll("this", "esto");
        code1 = code1.replaceAll("await", "esperar");
        return code1;
       }
      }
